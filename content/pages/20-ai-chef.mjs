export default {
  ...
  schemaType: 'WebPage',
  video: {
    src: '/assets/app/cookmode-polly.mp4',
    poster: '/assets/app/cookmode-poster.webp',
    posterAbs: '/assets/app/cookmode-poster.jpg',
    width: 444,
    height: 876,
    duration: 'PT12S',
    uploadDate: '2026-09-24',
    name: 'Cooking Beef Wellington with Polly, the AI chef in Glutt',
    description:
      'A screen recording of Glutt cook mode: the missing-ingredients check before you start, Polly talking the cook through searing the beef fillet, and a technique clip playing inline.',
    caption: 'Twelve seconds of cook mode: what you are missing, then Polly talking you through the sear.',
  },
  mentionsApp: true,
  includeApp: true,
